...
public class AuthorizationChecker {
    ...
    public boolean hasApplicationRole(String roleName) {
        IdentityManager identityManager = partitionManager.createIdentityManager(identity.getAccount().getPartition());
        Role role = getRole(identityManager, roleName);
        return role != null && hasRole(this.relationshipManager, this.identity.getAccount(), role);
    }
