...
angular.module("SecurityServices")
    ...
    .factory('SignRequestInterceptor', ['$rootScope', '$q', '$location', 'iqConstants', 'StringToSign', 'SecurityToken', 'DLabsDate',
        function($rootScope, $q, $location, iqConstants, StringToSign, SecurityToken, DLabsDate) {
            var signRequestInterceptor = {
                request: function(config) {
                    ...
                    stringToSign = StringToSign.buildStringToSignParameters(
                        ...
                        '/' + iqConstants.CONTEXT + '/' + StringToSign.getUri(config),
