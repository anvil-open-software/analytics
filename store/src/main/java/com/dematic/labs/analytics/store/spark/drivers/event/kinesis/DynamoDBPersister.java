...
public final class DynamoDBPersister implements Serializable {
    private transient static final Logger LOGGER = LoggerFactory.getLogger(DynamoDBPersister.class);
    ...
    public static void main(final String[] args) {
        ...
        // persist events
        final DynamoDBPersister persister = new DynamoDBPersister();
